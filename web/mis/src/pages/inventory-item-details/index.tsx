...
import EditItemInfo from "./components/edit-item-info";
...
const InventoryItemDetails = () => {
  ...
  const handleAddSpecs = (data: InvItemSpecs) => {
    setItemSpecs({ ...itemSpecs, data: [data, ...itemSpecs.data] });
  };

  const handleDeleteSpecs = (data: InvItemSpecs) => {
    setItemSpecs({
      ...itemSpecs,
      data: itemSpecs.data.filter((i) => i.id != data.id),
    });
  };
  return (
    <>
