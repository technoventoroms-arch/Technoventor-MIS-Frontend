...
import { roleName } from "@mono/shared_ui/constants/role-mapping";
...
const UserForm = ({
  ...
  const disableRoleSelect =
    isEditMode &&
    defaultValues &&
    (defaultValues.role_name == roleName.ORG_ADMIN ||
      (org.activeOrganization?.admin.identity_provider_id ==
      user.user?.identity_provider_id
        ? false
        : defaultValues.role_name == "admin"));
            ...
            <ControlledFormSelect
              ...
              options={
                disableRoleSelect
                  ? [
                      defaultValues.role_name == roleName.ORG_ADMIN
                        ? { label: "Org Admin", value: defaultValues.role_name }
                        : { label: "Admin", value: defaultValues.role_name },
                    ]
                  : [
